...
description: "OpenClaw bridge skill for c level advisor competitive intel. Use when tasks match this specialized claude-skills capability and need OpenClaw-native execution with explicit verification."
---
