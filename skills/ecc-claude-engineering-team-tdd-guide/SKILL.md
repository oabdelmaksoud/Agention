...
description: "Bridge skill for claude-skills 'engineering-team/tdd-guide'. Use when requests match this specialized domain; adapt guidance to OpenClaw-native tools and verification."
---
...
## Source
- `Upstream skill snapshot: upstream-import/claude-skills/references/engineering-team/tdd-guide`
