...
description: "Bridge skill for claude-skills 'finance/financial-analyst'. Use when requests match this specialized domain; adapt guidance to OpenClaw-native tools and verification."
---
...
## Source
- `Upstream skill snapshot: upstream-import/claude-skills/references/finance/financial-analyst`
