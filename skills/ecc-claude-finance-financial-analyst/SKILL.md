...
description: "OpenClaw bridge skill for finance financial analyst. Use when tasks match this specialized claude-skills capability and need OpenClaw-native execution with explicit verification."
---
