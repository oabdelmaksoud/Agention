...
description: "Bridge skill for claude-skills 'ra-qm-team/capa-officer'. Use when requests match this specialized domain; adapt guidance to OpenClaw-native tools and verification."
---
...
## Source
- `Upstream skill snapshot: upstream-import/claude-skills/references/ra-qm-team/capa-officer`
