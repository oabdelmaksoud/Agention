...
description: "Bridge skill for claude-skills 'ra-qm-team/mdr-745-specialist'. Use when requests match this specialized domain; adapt guidance to OpenClaw-native tools and verification."
---
...
## Source
- `Upstream skill snapshot: upstream-import/claude-skills/references/ra-qm-team/mdr-745-specialist`
