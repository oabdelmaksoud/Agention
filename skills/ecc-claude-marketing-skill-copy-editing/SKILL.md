...
description: "Bridge skill for claude-skills 'marketing-skill/copy-editing'. Use when requests match this specialized domain; adapt guidance to OpenClaw-native tools and verification."
---
...
## Source
- `Upstream skill snapshot: upstream-import/claude-skills/references/marketing-skill/copy-editing`
