...
description: "OpenClaw bridge skill for engineering ci cd pipeline builder. Use when tasks match this specialized claude-skills capability and need OpenClaw-native execution with explicit verification."
---
