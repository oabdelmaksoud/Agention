...
description: "Bridge skill for claude-skills 'project-management/senior-pm'. Use when requests match this specialized domain; adapt guidance to OpenClaw-native tools and verification."
---
...
## Source
- `Upstream skill snapshot: upstream-import/claude-skills/references/project-management/senior-pm`
