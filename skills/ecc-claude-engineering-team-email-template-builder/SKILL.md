...
description: "OpenClaw bridge skill for engineering team email template builder. Use when tasks match this specialized claude-skills capability and need OpenClaw-native execution with explicit verification."
---
