...
description: "Bridge skill for claude-skills 'c-level-advisor/agent-protocol'. Use when requests match this specialized domain; adapt guidance to OpenClaw-native tools and verification."
---
...
## Source
- `Upstream skill snapshot: upstream-import/claude-skills/references/c-level-advisor/agent-protocol`
