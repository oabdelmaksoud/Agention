...
description: "Bridge skill for claude-skills 'engineering/tech-debt-tracker'. Use when requests match this specialized domain; adapt guidance to OpenClaw-native tools and verification."
---
...
## Source
- `Upstream skill snapshot: upstream-import/claude-skills/references/engineering/tech-debt-tracker`
