...
description: "OpenClaw bridge skill for product team competitive teardown. Use when tasks match this specialized claude-skills capability and need OpenClaw-native execution with explicit verification."
---
