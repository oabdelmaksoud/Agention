...
description: "OpenClaw bridge skill for engineering mcp server builder. Use when tasks match this specialized claude-skills capability and need OpenClaw-native execution with explicit verification."
---
