...
description: "OpenClaw bridge skill for engineering release manager. Use when tasks match this specialized claude-skills capability and need OpenClaw-native execution with explicit verification."
---
