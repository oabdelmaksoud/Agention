...
description: "Bridge skill for claude-skills 'business-growth/customer-success-manager'. Use when requests match this specialized domain; adapt guidance to OpenClaw-native tools and verification."
---
...
## Source
- `Upstream skill snapshot: upstream-import/claude-skills/references/business-growth/customer-success-manager`
