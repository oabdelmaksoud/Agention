...
description: "Bridge skill for claude-skills 'product-team/product-manager-toolkit'. Use when requests match this specialized domain; adapt guidance to OpenClaw-native tools and verification."
---
...
## Source
- `Upstream skill snapshot: upstream-import/claude-skills/references/product-team/product-manager-toolkit`
