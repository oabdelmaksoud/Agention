...
description: "OpenClaw bridge skill for product team product manager toolkit. Use when tasks match this specialized claude-skills capability and need OpenClaw-native execution with explicit verification."
---
